...
# Set Args
def parse_args():
    parser = argparse.ArgumentParser(description="Initialize RagAgent with database and JSON path.")
    parser.add_argument("--db_name", required=True, help="Name of the Chroma database")
    parser.add_argument("--json_path", required=True, help="Path to the JSON file for database creation")
