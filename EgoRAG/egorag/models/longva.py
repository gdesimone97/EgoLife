...
class Longva(BaseQueryModel):
    def __init__(
        ...
        **kwargs,
        ...
        self.tokenizer, self.model, self.image_processor, self._max_length = load_pretrained_model(pretrained, None, "llava_qwen", device_map="cuda:0")
    ...
    def inference_video(self, video_path, video_start_time, start_time, end_time, human_query, system_message=''):
        ...
        video_tensor = self.image_processor.preprocess(video, return_tensors="pt")["pixel_values"].to(self.model.device, dtype=torch.float16)
